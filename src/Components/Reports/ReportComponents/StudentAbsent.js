...
import { getStudentAbsent } from "../../../Actions";
...
export default function StudentAbsent() {
  ...
  useEffect(() => {
    dispatch(getStudentAbsent(Data));
...
const data = report.StudentAbsentList && report.StudentAbsentList.map((item) => (
  {
