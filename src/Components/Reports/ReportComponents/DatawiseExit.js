...
import { getDateWiseExit } from "../../../Actions";
...
export default function DatawiseExit() {
  const dispatch = useDispatch();
  const Data= JSON.parse(localStorage.getItem("report"));
  useEffect(() => {
    dispatch(getDateWiseExit(Data));
  ...
  const columns = [
    ...
    { title: 'Exit Date Time', field: 'exitDate' },
  ...
  const data = 
  report.DateWiseExitReport && report.DateWiseExitReport.map((item) => (
    {
